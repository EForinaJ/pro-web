...
import { fetchGetAccountMenus } from '@/api/account'
...
export class MenuProcessor {
  ...
  private async processBackendMenu(): Promise<AppRouteRecord[]> {
    ...
    const res = await fetchGetAccountMenus()
    const menu = this.convertMenuToRouteTree(res.list)
    return this.filterEmptyMenus(menu)
  }
   ...
   * @returns 
   */
  private convertMenuToRouteTree (menuList: Menu.Response.List[]): AppRouteRecord[] {
